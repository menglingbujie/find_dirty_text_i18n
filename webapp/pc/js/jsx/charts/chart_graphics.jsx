...
export default class ChartGraphics {
  ...
  // STOP TRADE
  addStopLine(value) {
    this.addLine(ChartConfig.staticCfg.plineIdStop, value, LangClient.i18n('Trade closed'), ChartConfig.staticCfg.stopFontColor, ChartConfig.staticCfg.lineColorStop, 'dash', true, 270);
  }
  ...
  addStopIcon(value) {
    let src = this.urlCdn + "/pc/images/icon_stop_buy.png";
    let iconSize = 20;
  ...
  // REVEAL
  addRevealLine(value) {
    this.addLine(ChartConfig.staticCfg.plineIdReveal, value, LangClient.i18n('Announced'), ChartConfig.staticCfg.revealFontColor, ChartConfig.staticCfg.lineColorReveal, 'dash', true, 270);
  }
  ...
  addRevealIcon(value) {
    let src = this.urlCdn + "/pc/images/icon_reveal.png";
    let iconSize = 20;
  ...
  _addTradeIcon(x, y, isUp) {
    ...
    let src = isUp
      ? this.urlCdn + "/pc/images/icon_buy_up.png"
      : this.urlCdn + "/pc/images/icon_buy_down.png";
  ...
  addCurLabel(value) {
    ...
    let x = this.myChart.plotWidth + this.myChart.plotLeft - 12;
