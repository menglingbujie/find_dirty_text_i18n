...
export default class TradeWebView extends React.Component {
  constructor(props) {
    super(props);
    ...
    if (window) {
      window.enableTestLog = this.getParameterByName("debug") == 1
        ? true
        : false;
    }
  }
  ...
  componentDidMount() {
    this.testLog("===location.search===" + location.search);
    this.testLog("===token===" + Cookie.getCookie("token"));
    this.testLog("===userinfo===" + Cookie.getCookie("userinfo"));
