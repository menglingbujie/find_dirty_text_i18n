...
function* matchI18n(_,text,flat,plat){
  ...
  yield _;
  // console.log(_key+"="+_findViewPath)
...
// function matchI18n(text,flat,plat){
//   var _findProjectPath = projectPath+plat+"/";
//   var _cmd = "grep -r 'LangClient.i18n(\""+ text.replace(/\.$/,"") +"\")' "+_findProjectPath+"js | grep -v vjs";
//   // console.log(_cmd);
//   var _grepText = spawn(_cmd,[]);
//   _grepText.stdout.on("data",(data)=>{
//     console.log(`${data}`);
//   })
//   _grepText.stderr.on("data",(data)=>{
//     console.log(`grep stderr: ${data}`);
//   })
//   _grepText.stdout.on("close",(code)=>{
//     if (code !== 0) {
