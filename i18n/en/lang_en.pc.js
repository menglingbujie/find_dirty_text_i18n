module.exports = {
  __flat: {
    ...
    "Revenue": "Return",
    "Closed Positions": "Closed Trades",
    "Top Up/Withdraw": "Deposit/Withdraw",
    "Currency": "Currency",
    "Amount": "Amount",
    ...
    "Sign up to get $1000 bonus": "Sign up and get a free $1000 Demo account",
    "Switch to Real account to get a $100 bonus": "Switch to Real account to get a $100 bonus",
    ...
    "Warm Tips": "Warm Tips",
    "1. In case we notice any misbehavior in the activity, Eagles Banc's reserves the right to pause the Withdraw process before it is fully explained.": "1. In case we notice any misbehaviors happening in the activity, Ultrabanc reserves the right to pause the Withdrawl process before it is fully explained.",
    ...
    "About Us": "About Us",
    "About Binary Options": "About Binary Options",
    "Binary Options Introduction": "Binary Options",
    ...
    "Warm Tips": "Warm Tips",
    "1. In case we notice any misbehavior in the activity, Eagles Banc's reserves the right to pause the Withdraw process before it is fully explained.": "1. In case we notice any misbehavior in the activity, Ultrabanc reserves the right to pause the Withdraw process before it is fully explained.",
    "2. We reserve the right to contact you to offer further explanation of the terms of the activity and details of your behavior": "2. We reserve the right to contact you to offer further explanation of the terms of the activity and details of your behavior",
    "Convert to the real account": "Convert to the real account",
    ...
    "Eaglets: for first deposits of less than $2,000": "Ultrabanc: for first deposits of less than $2,000",
    ...
    "Transactions are updated in real time as your binary options trades are actioned.": "Transactions are updated in real time as your binary options trades are actioned.",
    ...
    "Withdrawing your bonus is possible after you have fulfilled the terms and conditions related to the bonus. For further clarification, see the \"PROMOTIONS\" section under \"MARKETING\".": "Withdrawing a bonus is possible as long as you fulfil the terms and conditions related to withdrawals. For further clarification, see 'Withdraw'.",
    ...
    "If you wish to close your account, please contact your account manager or send an email request to: info@Ultrabanc.com.": "If you wish to close your account, please send an email request to info@ultrabanc.com.",
    ...
    "Mr. Jiang - Gold Analyst": "David Johnson - Gold Analyst",
    "Devin•LI - Gold Analyst": "Owen Campbell - Gold Analyst",
    "Ms. Huang - Senior Analyst": "Hannah White - Senior Analyst",
    ...
    "Most providers will have a success rate between 70-80%. Ideally you should test several different signal services with a demo account using the signal trial period and decide which one works best for you;": "Most providers will have a success rate between 70-80%. Ideally you should test several different signal services with a demo account using the signal trial period to decide which one works best for you.",
    ...
    "The expiry rate is the price of the underlying asset at the time of expiry according to feed providers such as Reuters. This is the determining factor in if the option has expired in-the-money or out-of-the-money.": "The expiration rate is the price of the underlying asset at the time of expiration according to feed providers such as Reuters. This is the determining factor to which an option expires in the money or out of the money.",
    "\"Call\" represents the “up” direction that a price may take. If you believe that the price of the asset will rise by the expiry, then “call” is the button to click.": "\"Call\" represents the \"up\" direction that a price may take. If you believe that the price of the asset will rise by the expiry time, then \"CALL\", in the case of Ultrabanc \"HIGH\" is the button to click.",
    ...
    "If you are close to your expiry time, and you think that the direction you predicted is on a roll, then you have the chance to “do it again” by clicking on Double Up. By doing this, you can create a new trade with the same conditions, for the current price of the asset. In a nutshell, when things look good, Double Up gives you the opportunity to increase your investment and thus, double your profits. Double Up Benefits: Increase your investment on open positions IMake double the profit on expiry IImmediately capitalize on a strong position": "If your trading asset is close to its expiry time, and you think that the direction you predicted is on a roll, then you have the chance to \"do it again\" by clicking on 'Double Up'. By doing this, you can create a new trade with the same conditions, for the current price of the asset. In a nutshell, when things look good, Double Up gives you the opportunity to increase your investment and thus, double your profits.<br/><br/>Double Up Benefits:<br/>Increase your investment on open positions<br/>Double the profit on expiry time<br/>Immediately capitalize on a strong position",
    "11. Why the expiry level is different with the chart above showed?": "11. Why is the expiry level different to the chart shown?",
    "This is due to market price of the assets changes in a very short time during calculation. And also the delay of the chart due to the speed of internet will also make this difference, especially in short-term options like 60s, 120s. This is due to market price of the assets changes in a very short time, and 60 seconds options’ trading time is very short, the price with very small fluctuations will be amplified. As the web speed factors may cause the delay of trend graph, if you can not accept this price volatility, we do not recommend to trade 60 seconds, 120 seconds and 300 seconds, these short-term options.": "This happens because the market price of the assets change in a very short period of time during calculations. It can also be caused due to the speed of internet causing a delayed difference, especially in short-term options like 60 seconds and 120 seconds.<br/>For example, in a 60 seconds option trading, the time is very short, so the price with very small fluctuations will be amplified. Because the web speed factors may cause delays of trends in graph, we do not recommend trades of 60 seconds, 120 seconds and 300 seconds for those who cannot accept this kind of price volatility.",
    ...
    "Of course! Even if your withdrawal request is being processed, you can still cancel the withdrawal and return the money to your Ultrabanc account. The withdrawal cancellation option is especially useful when you do not have sufficient funds in your account, but you wish to continue trading. You can simply cancel your withdrawal by contacting us by phone or email.": "Yes, there is a withdrawal fee of $25 per transfer.<br/>However, every withdrawal request greater than $2000 is not only free of charge but is also unlimited, Ultrabanc will cover the transaction fee.",
    "4. Can I cancel a withdrawal? How so?": "4. Is there a withdrawal fee?",

    "Notice of the end of Bonus Activity":"Notice of the end of Bonus Activity",
    "Dear users":"Dear users",
    "Since the beginning of the Bonus Activity the total number of participants in our binary trading platform has increased significantly.":"Since the beginning of the Bonus Activity the total number of participants in our binary trading platform has increased significantly.",
    "In order to better serve each one of you, ULTRABANC has decided to launch a new promotion - the Insurance Activity.":"In order to better serve each one of you, ULTRABANC has decided to launch a new promotion - the Insurance Activity.",
    "As the previous Bonus Activity and the new Insurance Activity share similar grounds, we have decided to terminate the Bonus Activity on November 18th, 2016. This change means that on that day ULTRABANC will readjust the balance of the Bonus Activity participants who have not yet made a deposit. In this situation we highly recommend making a deposit before the due date in order to enjoy the benefits generated by the Bonus Activity.":"As the previous Bonus Activity and the new Insurance Activity share similar grounds, we have decided to terminate the Bonus Activity on November 18th, 2016. This change means that on that day ULTRABANC will readjust the balance of the Bonus Activity participants who have not yet made a deposit. In this situation we highly recommend making a deposit before the due date in order to enjoy the benefits generated by the Bonus Activity.",
    "Remember - only an immediate deposit will save your BONUS!":"Remember - only an immediate deposit will save your BONUS!",
    ...
    "If a trader losses, Ultrabanc will share the loss with the trader.": "If a trader losses, Ultrabanc will share the loss with the trader.",
    "How it works:": "How it works:",
    "1. The Insurance Activity is available for existing traders who have not yet completed a deposit. Ultrabanc will give an insurance of the same value as traders\' very first deposit.":"1. The insurance coverage is applicable only for the users who have made the deposit and have expressed their will to participate in the Activity. Insurance is valid only within 24 hours after the first deposit made after the launch of Insurance Activity, which is November 21st 2016. That is to say, all the deposits made within 24 hours are covered by the insurance.",
    "2. The insurance covers traders\' very first deposit and the additional deposits made until mid-night of that same day, to which it guarantees a maximum coverage of $10,000 per trader.":"2. The maximum insurance coverage is $10,000 per Trader.",
    "3. Traders are entitled to obtain an insurance money worth 50% of their total net loss, when only their net loss equals to 90% of their cumulative deposited amount of that first deposit day.":"3. Minimum requirements to claim insurance:<br/>&nbsp&nbsp&nbsp&nbspa. The Insurance coverage maximum amount equals to the amount of deposit remitted for the purposes of the Insurance Activity.<br/>&nbsp&nbsp&nbsp&nbspb. Trader’s net loss on the opened positions must reach 90% of their insurance coverage amount <br/>&nbsp&nbsp&nbsp&nbspc. The total transaction amount (trades which ended in-the-money and out-of-the-money) should exceed 5x of the insured amount, which is your initial deposit participating in Insurance Activity.",
    "Get Your Insurance" : "Get Your Insurance",
    "Total deposit available for insurance:" : "Total deposit available for insurance:",
    "Net Loss Amount:" : "Net Loss Amount:",
    "Insurance Coverage Ratio:" : "Insurance Coverage Ratio:",
    "Insurance Compensation Pay-outs:" : "Insurance Compensation Pay-outs:",
    "A trader can only participate in the Insurance Activity once" : "A trader can only participate in the Insurance Activity once",
    "The insurance coverage is limited to the total deposit you make today. The more you deposit today, the greater is your insurance." : "The insurance coverage is limited to the total deposit you make today. The more you deposit today, the greater is your insurance.",
    "Accept" : "Accept",
    "Join the Insurance Acitivity": "Join the Insurance Acitivity",
    "GET YOUR INSURANCE": "GET YOUR INSURANCE",
    "Your total net loss does not yet qualify to be insured": "Your total net loss does not yet qualify to be insured",

    // insurance pop end


    "Insurance Activity":"Insurance",
    "Free Insurance, reduce your investments’ risk":"Free Insurance, reduce your investments’ risk",
    "Ultrabanc aims at providing users with a perfect trading platform environment where traders are able to maximize their earnings. Therefore, Ultrabanc presents you with a new Insurance Activity: if a trader losses, Ultrabanc will share the loss with the trader.":"Ultrabanc aims at providing users with a perfect trading platform environment where traders are able to maximize their earnings. Therefore, Ultrabanc presents you with a new Insurance Activity: if a trader losses, Ultrabanc will share the loss with the trader",
    "How it works":"How it works",
    "1. The Insurance Activity is available for existing traders who have not yet completed a deposit. Ultrabanc will give an insurance of the same value as traders\' very first deposit.":"1. The insurance coverage is applicable only for the users who have made the deposit and have expressed their will to participate in the Activity. Insurance is valid only within 24 hours after the first deposit made after the launch of Insurance Activity, which is November 21st 2016. That is to say, all the deposits made within 24 hours are covered by the insurance.",
    "2. The insurance covers traders\' very first deposit and the additional deposits made until mid-night of that same day, to which it guarantees a maximum coverage of $10,000 per trader.":"2. The maximum insurance coverage is $10,000 per Trader.",
    "3. Traders are entitled to obtain an insurance money worth 50% of their total net loss, when only their net loss equals to 90% of their cumulative deposited amount of that first deposit day.":"3. Minimum requirements to claim insurance:<br/>&nbsp&nbsp&nbsp&nbspa. The Insurance coverage maximum amount equals to the amount of deposit remitted for the purposes of the Insurance Activity.<br/>&nbsp&nbsp&nbsp&nbspb. Trader’s net loss on the opened positions must reach 90% of their insurance coverage amount <br/>&nbsp&nbsp&nbsp&nbspc. The total transaction amount (trades which ended in-the-money and out-of-the-money) should exceed 5x of the insured amount, which is your initial deposit participating in Insurance Activity.",
    "4. There aren’t any deposits or withdrawals restrictions for traders participating in the Insurance Activity.":"4. Traders who meet the above requirements for insurance coverage are entitled to obtain the reimbursement valued at 50% of their insurance coverage amount.",
    "5. Each trader is entitled to receive the insurance money once.":"5. The insurance will be valid for period of one year starting from the date of traders’ first deposit after Insurance Activity Launch.",
    "6. The Insurance will be valid for period of one year starting from the date of traders’ first deposit.":"6. The Insurance will be valid for period of one year starting from the date of traders’ first deposit.",
    "Notice:":"Notice:",
    "We reserve the right to contact you and offer further explanations regarding the above stated terms of activity and your behavior towards it.":"We reserve the right to contact you and offer further explanations regarding the above stated terms of activity and your behavior towards it.",
    "We also reserve the right to cancel any illegal gains resulted by wrong doings performed while participating in this Insurance Activity.":"We also reserve the right to cancel any illegal gains resulted by wrong doings performed while participating in this Insurance Activity.<br/>* Traders who participated in previous Bonus activity plus completed a deposit, do not qualify for insurance coverage.",

    "INSURANCE":"INSURANCE",
    "The Bonus Activity Has Ended.":"The Bonus Activity Has Ended.",

    "contact us":"CONTACT US",
    "Details":"Details",

    "Insurance covers your deposits made in the first 24 hours. The more you deposit, the more you can get.": "Insurance covers your deposits made in the first 24 hours. The more you deposit, the more you can get.",
    "Participation Time:": "Participation Time:",
    "JOIN NOW":"JOIN NOW",


   // info about us
    "This site is owned and managed by Finance Managers Co. Limited": "This site is owned and managed by Finance Managers Co. Limited",
    ...
    "Pull option":"Put Option",
    "A binary option that the expiring price of an asset is lower than the market price, in which the trader will get profit when the market price of an asset is expiring below the current market price.":"A binary option that the expiring price of an asset is lower than the market price, in which the trader will get profit when the market price of an asset is expiring below the current market price.",
    "IN-THE-MONEY":"In the Money",
    "This term means that the market price of the asset is currently trading or has closed and is profitable.":"This term means that the market price of the asset is currently trading or has closed and is profitable.",
    ...
    "Used when the market price of the asset is currently trading at or has closed at the exact target price.":"Used when the market price of the asset is currently trading at or has closed at the exact target price.",

    "Boundary Option":"Boundary Option",
    "The trader decides whether market price is within or beyond a given price range upon trading maturity.":"The trader decides whether market price is within or beyond a given price range upon trading maturity.",
    "ONE-TOUCH OPTION":"One Touch Option",
    "The trader decides whether the price of the asset will reach a boundary within a certain time frame, it will be profitable as long as the price reaches the boundary.":"The trader decides whether the price of the asset will reach a boundary within a certain time frame, it will be profitable as long as the price reaches the boundary.",
    "Market price is the current price of the asset based on the feed by the data provider.":"Market price is the current price of the asset based on the feed by the data provider.",
    "Expiry rate":"Expiry Rate",
    "The asset price of which an option expires.":"The asset price of which an option expires.",
    "Expiry date":"Expiry Date",

    "The time and date at which an option expires.":"The time and date at which an option expires.",
    "Early Closure":"Early Closure",
    "The trader has the right to close the deal before expiry date. They also are profitable if the option is in-the-money option.":"The trader has the right to close the deal before expiry date. The early closure is also profitable if the option is in the money.",
    "Bull market and bear market":"Bull Market and Bear Market",
    "A bull market is a financial market of a group of securities in which prices are rising or are expected to rise above 20%.":"Bull market is a financial market of a group of securities in which prices are rising or are expected to rise above 20%.",

    "Bear market indicates market condition in which the prices of securities are falling, and widespread pessimism causes the negative sentiment to be self-sustaining.":"Bear market indicates market condition in which the prices of securities are falling, and widespread pessimism causes the negative sentiment to be self-sustaining.",
    "A central bank, is an institution authorized by state that manages a state's currency, money supply, and interest rates, controls the state’s economic situation and supervises commercial institutions.":"A central bank, is an institution authorized by state that manages a state's currency, money supply, and interest rates, controls the state’s economic situation and supervises commercial institutions.",
    "Economic indicator":"Economic Indicator",
    "The date that shows the economic growth, downturn or steady state including GDP, unemployment rate, total retail sales of consumer goods and etc.":"The date that shows the economic growth, downturn or steady state including GDP, unemployment rate, total retail sales of consumer goods and etc.",
    ...
    "An European option is an option that can only be exercised at the end of its life, at its maturity.":"An European option is an option that can only be exercised at the end of its life, at its maturity.",
    // FQAs
    "1. How do I make a deposit?":"1. How do I make a deposit?",
    "After you have registered as a member of Ultrabanc, log in to your account, click 'DEPOSITS' and follow the steps displayed. It is safe to deposit funds into your account as well as hassle free, it only takes a few minutes to complete.":"After you have registered as a member of Ultrabanc, log in to your account, click \"DEPOSIT\" on the top right corner of the page and follow the steps displayed. It is safe to deposit funds into your account as well as it is hassle free, it only takes a few minutes to complete the deposit process. Please certify that you are making a deposit in the same language you have registered Ultrabanc's account with in order to avoid deposit failures.",
    "6. How soon after making a deposit can I start trading?":"6. How soon after making a deposit can I start trading?",
    "Some payment transactions are completed instantly while others can take up to 3 days to be received by Ultrabanc. You are free to trade the minute we receive the deposit and funds are credited in your Ultrabanc account. Thus please allow up to 3 working days for the deposit to appear in your balance.":"Some payment transactions are completed instantly while others can take up to 3 days to be received by Ultrabanc. You are free to trade the minute we receive the deposit and funds are credited in your Ultrabanc account. Thus please allow up to 3 working days for the deposit to appear in your balance.",
    "If you have any questions regarding deposits, please contact us by email at account@ultrabanc.com or by phone at (+1) 631 437 0789.":"If you have any questions regarding deposits, please contact us by email at account@ultrabanc.com or by phone at (+1) 631 437 0789.",
    "7. Why can't I complete a deposit transaction?":"7. Why can't I complete a deposit transaction?",
    "Please certify that you are making a deposit in the same language you have registered an account with Ultrabanc, in order to avoid deposit failures. Our platform caters clients globally, to which payment options vary accordingly to the language choosen. You are able to switch languages as you wish when navigating Ultrabanc's website, it is only for deposits that we strongly recommend that you keep the page in the same language you opened an account with.":"Please certify that you are making a deposit in the same language you have registered an account with Ultrabanc, in order to avoid deposit failures. Our platform caters clients globally, to which payment options vary accordingly to the language choosen. You are able to switch languages as you wish when navigating Ultrabanc's website, it is only for deposits that we strongly recommend that you keep the page in the same language you opened an account with.<br/><br/>If you have any questions or problems regarding the completion of deposits, please contact us by email at account@ultrabanc.com or by phone at (+1) 631 437 0789.",
    ...
    "2. What is the minimum withdrawal amount?":"2. What is the minimum withdrawal amount?",
    "The minimum withdrawal amount is $100.":"The minimum withdrawal amount is $50.",
    "3. What Payment methods can I use for withdrawing funds?":"3. Is there a maximum withdrawal amount?",
    "Currently Ultrabanc only offers one method for withdrawals being direct wire transfers. Withdrawal requests will only be paid after all documents are received and passed through the authentication process.":"There isn't. You may withdraw as much as you want as long as your total transactions volume reach 40% of total deposited amount.",
    "5. Is there a maximum withdrawal amount?":"5. What are the minimum requirements for a withdrawal?",
    "No. You may withdraw all of your funds at any time.":"Besides providing Ultrabanc with correct and updated information and documentation detailed at FAQ 1. How to withdraw?, a trader’s total transactions volume must reach 40% of total deposited amount.<br/>Applicants participating in the Bonus Activity, who have made a deposit however, must have a minimum trading volume of $2000 in order to qualify for a withdrawal.",
    "6. What Payment methods can I use for withdrawing funds?":"6. What Payment methods can I use for withdrawing funds?",
    "Currently Ultrabanc offers two method for withdrawals being:1. Credit card - We operate a \"return to source\" policy which means that credit card withdrawals will have funds only returned back to the same card used to fund the trading account, in 3 to 5 working days.  2. Bank Transfers - all other withdrawal requests are paid through bank transfers in 1 to 3 working  days. * Requests for withdrawals will only be paid after all documents have been received and after they have passed the authentication process.* ULTRABANC platform strictly abides by the Anti-Money Laundering Policy. Please ensure that any payment you make to us is made from a card and account in YOUR name and not from another party. Any remittances from/to third party sources will be rejected.":"Currently Ultrabanc offers two method for withdrawals being:<br/>1. Credit card - We operate a \"return to source\" policy which means that credit card withdrawals will have funds only returned back to the same card used to fund the trading account, in 3 to 5 working days.  <br/>2. Bank Transfers - all other withdrawal requests are paid through bank transfers in 1 to 3 working  days. <br/><br/>* Requests for withdrawals will only be paid after all documents have been received and after they have passed the authentication process.<br/>* ULTRABANC platform strictly abides by the Anti-Money Laundering Policy. Please ensure that any payment you make to us is made from a card and account in YOUR name and not from another party. Any remittances from/to third party sources will be rejected.",
    "7. Can I cancel a withdrawal?":"7. Can I cancel a withdrawal?",
    "You are able to cancel a withdrawal request only if the money has not yet been processed by the bank. To do so, go to 'Trade', and then 'Account', your deposit/withdrawal history will show the available 'Cancel' button. If the money has already been processed by the bank, the withdrawal cancelation button will not be available. The withdrawal cancellation option is especially useful when you do not have sufficient funds in your account, but you wish to continue trading.":"You are able to cancel a withdrawal request only if the money has not yet been processed by the bank. To do so, go to 'Trade', and then 'Account', your deposit/withdrawal history will show the available 'Cancel' button. If the money has already been processed by the bank, the withdrawal cancelation button will not be available. The withdrawal cancellation option is especially useful when you do not have sufficient funds in your account, but you wish to continue trading.",
    "1. Can I register more than one account?":"1. Can I register more than one account?",
    "2. How to edit my bank account information?":"2. How to edit my bank account information?",
    "Please contact us as soon as possible by email at account@ultrabanc.com or by phone at (+1) 631 437 0789.":"Please contact us as soon as possible by email at account@ultrabanc.com or by phone at (+1) 631 437 0789.",
    "3. How to view my trading history?":"3. How to view my trading history?",
    "Log into your account, go to 'Trade', under the graph you are able to see the tabs for 'Open trades' and  'Closed trades'.":"Log into your account, go to 'Trade', under the graph you are able to see the tabs for 'Open trades' and  'Closed trades'.",

    "4. How often are transactions updated in my account?":"4. How often are transactions updated in my account?",
    "5. Is it possible to withdraw my bonus?":"5. Is it possible to withdraw my bonus?",
    "6. How are my banking transactions secured?":"6. How are my banking transactions secured?",
    "Financial security is the biggest concern of users engaged in internet finance, but you can rest assure that when trading binary options with Ultrabanc, your financial security is our priority. All transactions are protected with a combination of security systems and firewalls, ensuring that your account and banking details are safe and secure. Our transaction security uses SSL (including both ClickSSL and Thawte) that goes above the industry standard. In addition, Eagle's Banc provides full transparency of the service fee and commission as an important part of its operation. We guarantee you that no additional brokerage fee or hiden commission will be charged. To learn more information about how we protect financial security, please contact us by e-mail cashcrusaders@ultrabanc.com or by phone number (+852) 53482546.":"Financial security is the biggest concern of users engaged in internet finance, but you can rest assure that when trading binary options with Ultrabanc, your financial security is our priority. All transactions are protected with a combination of security systems and firewalls, ensuring that your account and banking details are safe and secure. Our transaction security uses SSL (including both ClickSSL and Thawte) that goes above the industry standard. In addition, Ultrabanc provides full transparency of the service fee and commission as an important part of its operation. We guarantee you that no additional brokerage fee or hiden commission will be charged.",
    "7. How do I close my account?":"7. How do I close my account?",
    "8. What is a Swift Code?":"8. What is a SWIFT Code?",
    "Once you have deposited funds, you can make a trade by clicking on \“high\” if you believe that the price of the chosen asset will rise by expiry, or by clicking on “low” if you believe that the asset price will fall by the expiry time. You will then be asked the amount you wish to ivest, and to approve the trade. The selection may be canceled by clicking on \"X\" at any time before the approval of the trade. Please note that the rate keeps updating in the investment box.":"Once you have deposited funds, you can start trading by going to tab 'Trade', then choosing an asset, the expiry time and the amout you wish to trade. You may trade on \"HIGH\" if you believe that the price of the chosen asset will rise by expiry time, or by clicking on \"LOW\" if you believe that the asset price will fall by the expiry time.",
    "2. What are the rates displayed in the trading boxes?":"2. What are the rates sources?",
    "3. What is the expiration rate?":"3. What is the expiration rate?",
    "4. What is a Call Option?":"4. What is a Call Option?",
    "5. What is a Put Option?":"5. What is a Put Option?",
    "Put represents the “down” direction that a price may take. If you believe that the price of the asset will fall by the expiry time, then “put” is the button to click.":"Put represents the “down” direction that a price may take. If you believe that the price of the asset will fall by the expiry time,then “PUT”, in the case of Ultrabanc \"LOW\" is the button to click.",
    "6. What return will I get in case of a successful investment?":"6. What return will I get in case of a successful investment?",
    "7. What is the expiration time?":"7. What is the expiration time?",
    "8. Why do the rates continue to change before I make a decision?":"8. Why do the rates continue to change before I make a decision?",
    "9. What is Double Up?":"9. What is Double Up?",
    "10. Why am I unable to make a trade?":"10. Why am I unable to make a trade?",
    "APPLE (US)":"APPLE (US)",
    "MICROSOFT (US)":"MICROSOFT (US)",
    "This expiry time is no longer available, please select another one.": "This expiry time is no longer available, please select another one.",
    "The DEMO account is a demonstration account exactly like the REAL account exept that it serves an educational purpose, meaning that it is the perfect account to not only gain trading practice, but also a good opportunity to familiarize yourself with Ultrabanc's platform. It does not require any deposits and come with a balance of $1000 for you to play, given that no amount is available for withdrawal.":"The DEMO account is a demonstration account exactly like the REAL account exept that it serves an educational purpose, meaning that it is the perfect account to not only gain trading practice, but also a good opportunity to familiarize yourself with Ultrabanc's platform. It does not require any deposits and come with a balance of $1000 for you to play, given that no amount is available for withdrawal.",
    "In order to place real trade transactions at the REAL account, users are required to make at least one deposit. The REAL account also offers different promotional activities from time to time.":"In order to place real trade transactions at the REAL account, users are required to make at least one deposit. The REAL account also offers different promotional activities from time to time.",
    "Users can freely switch from DEMO to REAL and vice versa as they wish. To do so, click on the drop menu option right by your name on site's top right corner.":"Users can freely switch from DEMO to REAL and vice versa as they wish. To do so, click on the drop menu option right by your name on site's top right corner.",

    "Required Trading Amount:": "Required Trading Amount:",

    "Example: Marco decides to participate in the Insurance Activity and deposits $100. He then opens 9 positions for $10 each, but his fundamental analysis proves wrong and all his trades ended out-of-the-money.":"Example: Marco decides to participate in the Insurance Activity and deposits $100. He then opens 9 positions for $10 each, but his fundamental analysis proves wrong and all his trades ended out-of-the-money. He is left with $10 in his pocket and claims reimbursement. After the system adds $45 (50% of $90 Marco lost) he now starts off again with $55 in his wallet. He improves his formula of analysis and wins another 10 positions in a row earning $238. Satisfied, he can now withdraw his daily earnings.",
    "4. Traders who meet the above requirements for insurance coverage are entitled to obtain the reimbursement valued at 50% of their insurance coverage amount.":"4. Traders who meet the above requirements for insurance coverage are entitled to obtain the reimbursement valued at 50% of their insurance coverage amount.",
    "5. The insurance will be valid for period of one year starting from the date of traders’ first deposit after Insurance Activity Launch.":"5. The insurance will be valid for period of one year starting from the date of traders’ first deposit after Insurance Activity Launch.",
    ...
    "Teach You How To Become An Outstanding Agent":"Teach You How To Become An Outstanding Agent",
    "Insatisfactory platforms":"Insatisfactory platforms",
    "Always fail":"Always fail",
    "No funds":"No funds",
    "Mike wants to work as a financial agent":"Mike wants to work as a financial agent",
    "however":"however",
    "He doesn\'t know how to start":"He doesn't know how to start",
    "keeps trying, but always fail":"keeps trying, but always fail",
    "inexperienced":"inexperienced",
    "no reliable platform":"no reliable platform",
    "lack of":"lack of",
    "Expertise":"Expertise",
    "as a":"as a",
    "Beginner":"Beginner",
    "he doesn't know where to get support from":"he doesn't know where to get support from",
    "then he thought...if brokers could give him Support...":"then he thought...if brokers could give him <span>Support</span>...",
    "Ultrabanc is wonderful":"Ultrabanc is wonderful",
    "Confidence":"Confidence",
    "Through a friend, Mike joined Ultrabanc":"Through a friend, Mike joined Ultrabanc",
    "Ultrabanc\'s unique agent program allowed him to make money easier":"Ultrabanc\'s unique agent program allowed him to make money easier",
    "Customized commission plans helped him improve quickly":"Customized commission plans helped him improve quickly",
    "Mike had a week-long financial course with Ultrabanc":"Mike had a week-long financial course with Ultrabanc",
    "Ultrabanc provided a wonderful promotion plan for him":"Ultrabanc provided a wonderful promotion plan for him",
    "Mike gradually established his own extension system and confidently looks at his future":"Mike gradually established his own extension system and confidently looks at his future",
    "Through his efforts, Mike gets his first batch of users":"Through his efforts, Mike gets his first batch of users",
    "Mike\'s good management skills together with Ultrabanc\'s support, allows him to earn his first fortune":"Mike\'s good management skills together with Ultrabanc\'s support, allows him to earn his first fortune",
    "Mike continues to expand his team and upgrades his agent level":"Mike continues to expand his team and upgrades his agent level",
    "Income grows with his efforts":"Income grows with his efforts",
    "And the whole experience allows Mike to flourish in imaginable ways":"And the whole experience allows Mike to flourish in imaginable ways",
    "Want to become another Mike?":"Want to become another Mike?",
    "Join Ultrabanc now!":"Join Ultrabanc now!",
    "Join Ultrabanc":"Join Ultrabanc",
    "Contact US":"Contact US",
    "Submit Information":"Submit Information",
    "Sign Contract":"Sign Contract",
    "Become an Agent":"Become an Agent",
    "IB Education":"IB Education",

    "Personal center": "Personal center",
    "Hi": "Hi",
    "Balance": "Balance",
    "Total Trading Volume": "Total Trading Volume",
    "Profitable Trading Times": "Profitable Trading Times",
    "Total Transaction Times": "Total Transaction Times",
    "Profile": "Profile",
    "Bank Card": "Bank Card",
    ...
    "swift code": "Swift Code",
    "Bank\'s Branch Address": "Bank\'s Branch Address",
    "Upload": "Upload",
    "Only supports PNG, JPG, maximum size 2MB": "Only supports PNG, JPG, maximum size 2MB",
    "Only supports PNG, JPG, PDF, maximum size 2MB": "Only supports PNG, JPG, PDF, maximum size 2MB",
    "Rules:": "Rules:",
    "Please provide correct and accurate information to ensure a smooth documents authentication process!": "Please provide correct and accurate information to ensure a smooth documents authentication process!",
    "Documents are being authenticated, please wait patiently.": "Documents are being authenticated, please wait patiently.",
    "Documents\' authentication failed, please review your documents and informations and resubmit.": "Documents\' authentication failed, please review your documents and informations and resubmit.",
    "Documents have been authenticated with success.": "Documents have been authenticated with success.",
    "Please refer to the Rules": "Please refer to the Rules",
    "1. Attachments needed to be uploaded:": "1. Attachments needed to be uploaded:",
    "(1) Proof of ID - ID with photo, such as passport, driver\'s license, or any other form of government issued identity card.": "(1) Proof of ID - ID with photo, such as passport, driver\'s license, or any other form of government issued identity card.",
    "(2) Proof of residence - Confirm that you are resident in a country accepted by Ultrabanc with one of the following documents: recent utility bill (water, electricity or telephone bill) or  a bank/credit card statement.": "(2) Proof of residence - Confirm that you are resident in a country accepted by Ultrabanc with one of the following documents: recent utility bill (water, electricity or telephone bill) or  a bank/credit card statement.",
    "(3) Front picture of bank card.": "(3) Front picture of bank card.",
    '(4) Completed and signed <a target="_blank" href="http://source.ultrabanc.com/ultra/ASSESSMENT_OF_APPROPRIATENESS_EN_(11.10).pdf">Assessment of Appropriateness</a>.': '(4) Completed and signed <a target="_blank" href="http://source.ultrabanc.com/ultra/ASSESSMENT_OF_APPROPRIATENESS_EN_(11.10).pdf">Assessment of Appropriateness</a>.',
    '(5) If your deposit was made by credit card, please also fill in and submit the <a target="_blank" href="http://source.ultrabanc.com/ultra/Personal_Investor_Agreement_EN(11.14).pdf">Personal Investor Agreement</a>.': '(5) If your deposit was made by credit card, please also fill in and submit the <a target="_blank" href="http://source.ultrabanc.com/ultra/Personal_Investor_Agreement_EN(11.14).pdf">Personal Investor Agreement</a>.',
    "2. For the first withdrawal request, we need to authenticate your withdraw account information in order to ensure that your withdrawal payment can be made on time, thus please provide accurate information.": "2. For the first withdrawal request, we need to authenticate your withdraw account information in order to ensure that your withdrawal payment can be made on time, thus please provide accurate information.",
    "3. Documents authentication process will take 1-3 working days. All other withdrawal requests will be funded through this bank account in 1 to 3 working days.": "3. Documents authentication process will take 1-3 working days. All other withdrawal requests will be funded through this bank account in 1 to 3 working days.",
    "Country": "Country",
    "Modify": "Modify",
    "Change Password": "Change Password",
    "Field must be filled in": "Field must be filled in",
    "Must upload attachments": "Must upload attachments",
    "Upload success": "Upload success",
    "Upload failed": "Upload failed",
    "Uploading...": "Uploading...",
    "Changes have been saved.": "Changes have been saved.",
    "Old Password": "Old Password",
    "1. It is important that you always provide us with correct and accurate information in order for us to process your withdrawal request in time.": "1. It is important that you always provide us with correct and accurate information in order for us to process your withdrawal request in time.",
    "2. Document authentication process takes 1 to 3 working days. After your authentication has been approved, we will use this same bank account to transfer money.": "2. Document authentication process takes 1 to 3 working days. After your authentication has been approved, we will use this same bank account to transfer money.",
    "3. If you want to change you withdrawal account information, please send us an email at: account@ultrabanc.com": "3. If you want to change you withdrawal account information, please send us an email at: account@ultrabanc.com",
    "Country of Bank\'s Branch": "Country of Bank\'s Branch",
    "Bank\'s Phone Number": "Bank\'s Phone Number",
    "Front of Bank Card": "Front of Bank Card",
    "Back of Bank Card": "Back of Bank Card",
    "Front of ID": "Front of ID",
    "Back of ID": "Back of ID",
    "ID": "ID",
    "ID Number": "ID Number",
    "The format of ID Number is wrong, please enter again.": "The format of ID Number is wrong, please enter again.",

    "System added": "System added",
    "System deducted": "System deducted",
    "Insurance added": "Insurance added",
    "Bonus added": "Bonus added",
    "Deducted": "Deducted",

    // cooperation
    "Mutually Beneficial Cooperation":"Mutually Beneficial Cooperation",
    "Through cooperation we can reach the win-win result. Ultrabanc binary options cooperates with well-known trading agencies and brokers. Our know-how guarantees traders the best experience they can get.":"Through cooperation we can reach the win-win result. Ultrabanc binary options cooperates with well-known trading agencies and brokers. Our know-how guarantees traders the best experience they can get.",
    "5 * 24 hours trading time":"5 * 24 hours trading time",
    "Diverse assets Meet your diversified investment demands":"Diverse assets<br/>Meet your diversified investment demands",
    "Earn as much as 90% return Make money easily":"Earn as much as 90% return<br/>Make money easily",
    "Fixed income For each trading profit and loss rate":"Fixed income<br/>For each trading profit and loss rate",
    "Instant withdrawal within 2 hours":"Instant withdrawal within 2 hours",
    "Company Profile":"Company Profile",
    "Ultrabanc.com trading platform is independently operated by Ultrabanc, which is an Internet financial services provider, with strong financial background, great technical team and is committed to build a worldwide leading binary options.":"Ultrabanc.com trading platform is independently operated by Ultrabanc, which is an Internet financial services provider, with strong financial background, great technical team and is committed to build a worldwide leading binary options.",
    "Ultrabanc mainly provides binary options online trading, which can be accessed by PC Windows. Through Ultrabanc website, you can trade sevral assets such as stocks, forex, commodities and indices. The only thing you need to do is decide if the price of an option will be high or low.":"Ultrabanc mainly provides binary options online trading, which can be accessed by PC Windows. Through Ultrabanc website, you can trade sevral assets such as stocks, forex, commodities and indices. The only thing you need to do is decide if the price of an option will be high or low.",
    ...
    "Email: info@ultrabanc.com":"Email: info@ultrabanc.com",
    "Tel: (+852) 53482546":"Tel: (+1) 631 437 0789",
    "Business Partners":"Business Partners",
    "The Ant Studio":"The Ant Studio",
    "The Ant Studio was founded in April 2015, consists of analysts from Ant Financial Groups, the special financial commentator of CCTV channel and experienced Forex traders from private financial equities. The Ant Studio uphold the principle of \"Customer comes first and Integrity-based\", thus always putting traders\' profits in the first place.":"The Ant Studio was founded in April 2015, consists of analysts from Ant Financial Groups, the special financial commentator of CCTV channel and experienced Forex traders from private financial equities. The Ant Studio uphold the principle of \"Customer comes first and Integrity-based\", thus always putting traders' profits in the first place.",
    "Compared with other financial studios, the strongest characteristic of Ant Studio is: \"Only act as the Forex dealer, not the Market maker\". The open office allows traders to come by and visit, and experience a wonderful trading environment. Each trader can obtain instructions from professionals and for those trading in the studio, we guarantee fund securities and monthly stable revenues. By making money, you are able to adhere new financial knowledge.":"Compared with other financial studios, the strongest characteristic of Ant Studio is: \"Only act as the Forex dealer, not the Market maker\". The open office allows traders to come by and visit, and experience a wonderful trading environment. Each trader can obtain instructions from professionals and for those trading in the studio, we guarantee fund securities and monthly stable revenues. By making money, you are able to adhere new financial knowledge.",
